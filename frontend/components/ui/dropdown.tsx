  ...
  (
    ...
    return (
      <DropdownMenuPrimitive.Portal forceMount>
        <DropdownMenuPrimitive.Content forceMount side={side} align={align} sideOffset={sideOffset} render={<motion.div className="z-50 outline-none" initial={{ opacity: 0, y: -4, scaleY: 0.96 }} animate={
                          open
                            ? { opacity: 1, y: 0, scaleY: 1 }
                            : { opacity: 0, y: -4, scaleY: 0.96 }
                        } transition={open ? spring.fast : spring.fast.exit} style={{ transformOrigin: "top center" }} onAnimationComplete={() => {
                        ...
                        </DropdownContext.Provider></DropdownMenuPrimitive.Content>
